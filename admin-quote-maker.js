...
const PRODUCT_DATA = {
    "보라카이션 패키지": [
        { name: "시그니처 패키지 (성인) (픽샌 + 호핑 + 말룸 + 고래상어)", price: 280000 },
        { name: "시그니처 패키지 (소인) (픽샌 + 호핑 + 말룸 + 고래상어)", price: 270000 },
        { name: "패키지 A (성인/소인) (픽샌 + 호핑 + 고래상어)", price: 190000 },
        { name: "패키지 B (성인) (픽샌 + 호핑 + 말룸파티)", price: 195000 },
        { name: "패키지 B (소인) (픽샌 + 호핑 + 말룸파티)", price: 185000 },
        { name: "패키지 C (성인) (픽샌 + 고래상어 + 말룸파티)", price: 230000 },
        { name: "패키지 C (소인) (픽샌 + 고래상어 + 말룸파티)", price: 220000 },
        { name: "픽샌팩 A (성인/소인) (픽샌 + 호핑)", price: 100000 },
        { name: "픽샌팩 B (성인/소인) (픽샌 + 고래상어)", price: 135000 },
        { name: "픽샌팩 C (성인) (픽샌 + 말룸파티)", price: 150000 },
        { name: "픽샌팩 C (소인) (픽샌 + 말룸파티)", price: 140000 }
    ],
    "보라카이션 투어 콤보팩": [
        { name: "콤보팩 A (성인) (호핑 + 고래상어 + 말룸파티)", price: 260000 },
        { name: "콤보팩 A (소인) (호핑 + 고래상어 + 말룸파티)", price: 250000 },
        { name: "콤보팩 B (성인/소인) (호핑 + 고래상어)", price: 140000 },
        { name: "콤보팩 C (성인) (호핑 + 말룸파티)", price: 150000 },
        { name: "콤보팩 C (소인) (호핑 + 말룸파티)", price: 140000 },
        { name: "콤보팩 D (성인) (말룸파티 + 고래상어)", price: 180000 },
        { name: "콤보팩 D (소인) (말룸파티 + 고래상어)", price: 170000 }
    ],
    "보라카이 왕복 픽업샌딩": [
