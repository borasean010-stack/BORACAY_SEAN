...
const CAFE_TOUR_DB = {
    '고래': {
        ...
        program: '메인로드 졸리비 ➔ 리버타드 도착 및 브리핑 ➔ 고래상어 스노클링 ➔ 호텔 드랍',
    ...
    '호핑': {
        ...
        program: '12:30 / 13:30 기분 좋은 미팅 시작! (점보크랩 포함 여부에 따라 달라요!)\n14:00 ~ 15:30 1, 2차 물놀이 타임! 스노클링하고 간식 먹고 무한 반복!\n15:30 ~ 16:30 선상 클럽 개장! 댄스 공연부터 감성 폭발 라이브까지!\n17:00 물놀이 후 국룰! \'선상 라면+주먹밥\' 타임 (이게 진짜 맛도리인 거 아시죠?)\n17:30 ~ 18:00 보라카이의 하이라이트, 황홀한 선셋 감상 후 복귀',
