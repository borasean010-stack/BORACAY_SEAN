...
const PRODUCT_DATA = {
    "보라카이션 패키지": [
        { name: "시그니처 패키지 (성인) (픽샌 + 호핑 + 말룸 + 고래상어)", price: 310000 },
        { name: "시그니처 패키지 (소인) (픽샌 + 호핑 + 말룸 + 고래상어)", price: 300000 },
        { name: "패키지 A (성인) (픽샌 + 말룸 + 고래상어)", price: 260000 },
        { name: "패키지 A (소인) (픽샌 + 말룸 + 고래상어)", price: 250000 },
        { name: "패키지 B (성인/소인) (픽샌 + 호핑 + 고래상어)", price: 220000 },
    ...
    "보라카이션 투어 콤보팩": [
        { name: "콤보팩 A (성인) (호핑 + 원데이(말룸+고래상어))", price: 260000 },
        { name: "콤보팩 A (소인) (호핑 + 원데이(말룸+고래상어))", price: 250000 },
        { name: "콤보팩 B (성인/소인) (호핑 + 고래상어)", price: 165000 },
        { name: "콤보팩 C (성인) (호핑 + 말룸파티)", price: 150000 },
        { name: "콤보팩 C (소인) (호핑 + 말룸파티)", price: 141000 },
        { name: "콤보팩 D (성인) (원데이(말룸+고래상어))", price: 210000 },
        { name: "콤보팩 D (소인) (원데이(말룸+고래상어))", price: 200000 }
    ],
    "보라카이 왕복 픽업샌딩": [
