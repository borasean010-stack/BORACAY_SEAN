...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const productData = {
        essential: [
            ...
            { title: "블랙펄 요트호핑투어", img: "hopping.jpg", url: "hopping-tour.html", badge: "HOT", desc: "보라카이 최고의 럭셔리 요트에서 즐기는 환상적인 파티.", price: 85000 },
            { title: "시크릿가든 말룸파티", img: "malum1.jpg", url: "malumpati.html", badge: "HOT", desc: "에메랄드빛 블루라군에서 즐기는 시원한 다이빙과 휴식.", price: 99000 },
            { title: "한눈에 요금표", img: "price.png", url: "price-list.html", desc: "보라카이션의 모든 투어 요금을 한눈에 확인하세요.", price: null }
        ],
        activity: [
            { title: "블랙펄 요트호핑투어", img: "hopping.jpg", url: "hopping-tour.html", badge: "HOT", desc: "럭셔리 요트 위에서 즐기는 최고의 선셋과 스노클링.", price: 85000 },
            { title: "시크릿가든 말룸파티", img: "malum1.jpg", url: "malumpati.html", badge: "HOT", desc: "신비로운 블루라군 탐험과 푸짐한 현지식 오찬.", price: 99000 },
